...
$("#mobile_menu_about").click(function(){
    $("#mobile_menu").css("transform","translateX(100%)");
});
$("#mobile_menu_ph").click(function(){
    $("#mobile_menu").css("transform","translateX(100%)");
});
$("#mobile_menu_vid").click(function(){
    $("#mobile_menu").css("transform","translateX(100%)");
});
$("#mobile_menu_price").click(function(){
    $("#mobile_menu").css("transform","translateX(100%)");
});
$("#mobile_menu_ua").click(function(){
    $("#mobile_menu").css("transform","translateX(100%)");
});
